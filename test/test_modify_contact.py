...
def test_modify_contact(app):
    ...
    contact = Contact(first_name="modified_name"+'_'+str(index), middlename="", lastname="", nickname="", title="", company="", address="", home="",
...
def test_modify_contact_name(app):
    ...
    old_contacts = app.contact.get_contact_list()
    index = randrange(len(old_contacts))
    contact = Contact(first_name="modified_name"+'_'+str(index))
    contact.id = old_contacts[index].id
...
def test_modify_first_contact_email(app):
    ...
    old_contacts = app.contact.get_contact_list()
    index = randrange(len(old_contacts))
    contact = Contact(email="second_modified_email"+'_'+str(index))
    contact.id = old_contacts[index].id
